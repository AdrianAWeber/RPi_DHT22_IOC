...
/* Generated from ../O.Common/onewire.dbd */
...
epicsShareExtern dset *pvar_dset_dev_ai_d1w;
...
{
    const char *bldTop = "/home/pi/epics/onewire";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"onewire_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    onewire_registerRecordDeviceDriver(*iocshPpdbbase);
}
